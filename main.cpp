...
>>>>>>> refs/remotes/origin/JP
		...
		DataOferta * dtO = new DataOferta(49563,
			...
			"Buscamos estudiantes de Ingenieria con Calculo 1 y 2 aprobadas. Deben tener disponibilidad horaria y gusto por enseÃ±ar. Enviar mail a academiayotexplico@gmail.com.",
			5,
			500,
			2000,
			Date(10, 9, 2015),
...
>>>>>>> refs/remotes/origin/JP
				...
				//ingresoYChequeoDeDatosParaLaCreacionDeLaOferta
					...
					cout<<"Ingrese el numero de Expediente que se asociarÃ¡ a la nueva Oferta Laboral y luego presione [ENTER]. \n" ;
						cout<<" >";
						getline(cin, int_aux);
					...
					while (!okExp) {
						cout<<"Error!! \n";
						cout<<"El numero de expediente ingresado ya estÃ¡ registrado para otra Oferta Laboral.\n";
						cout<< "Ingrese otro numero de Expediente al que se asociarÃ¡ la nueva Oferta Laboral y luego presione [ENTER]. \n" ;
				...
				//chequearCandidatos y si no hay, listarEstrategias
					...
					if (!cand) {
						...
						if (!cnj.empty()) { //si el primer set es vacio ya sabemos que no hay ningun estudiante q haya salvado nada.
							...
							cout<<"Criterio 1: Sugiere las materias aprobadas de algÃºn estudiante.\n";
							...
							cout<<"Criterio 2: Sugiere una de las asignaturas seleccionadas, que algÃºn estudiante haya aprobado.\n";
							itstr++;
							cnj =*itstr;
							itbis=cnj;
					...
					//actualizarRequerimientos
						...
						while (!okCriterio) {
							cout<<"Error!!\n";
							cout<<"No ha ingresado una opciÃ³n valida, por favor ingrese [1] o [2] para aplicar uno de los"
